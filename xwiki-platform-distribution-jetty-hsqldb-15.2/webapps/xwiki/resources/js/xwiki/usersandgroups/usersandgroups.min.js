...
function(c){c=[c.undefined,c.allowed,c.denied];f.alt=c[a];e.title=c[a]})},nextState:function(){return(this.state+1)%this.nrstates},next:function(){this.state=this.nextState();void 0!=this.table&&delete this.table.fetchedRows[this.idx];this.draw(this.state)},createClickHandler:function(a){return function(){if(!a.req){var f="",e=(a.state+1)%a.nrstates;if(a.currentUorG==window.currentUser)if(2==e){var c="$escapetool.javascript($services.localization.render('rightsmanager.denyrightforcurrentuser'))".replace("__right__",
